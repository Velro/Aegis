...
function OnCollisionEnter (other : Collision){
	if (explosion != null && other.gameObject.layer != "ScreenBounds" && other.gameObject.name != gameObject.name){ //damage isn't dealt to collisions with other objects of the same name. This will prevent tight packs of enemies killing themselves.
